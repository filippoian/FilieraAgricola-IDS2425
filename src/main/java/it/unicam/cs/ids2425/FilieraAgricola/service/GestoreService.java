...
public class GestoreService {
        ...
        public void accreditaRuoloBase(Long userId, ERole ruoloNome) {
                ...
                // Controlla che l'utente abbia già quel ruolo
        ...
        public void accreditaProduttore(Long userId, AccreditaProduttoreRequest request) {
                ...
                // Crea il FilieraPoint (Azienda Agricola) e lo approva
                ...
                // Crea l'ActorProfile_Produttore collegandolo al profilo e al punto creato
